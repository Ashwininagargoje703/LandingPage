...
const metadata = [
  {
    ...
    description:
      "Our platform empowers developers to distribute their games across decentralized networks.",
  },
  {
    id: 2,
    icon: Icon2,
    title: "Play-to-Earn",
    description:
      "Leverage the power of blockchain to earn real rewards through gameplay.",
  },
  {
    id: 3,
    icon: Icon3,
    title: "Tournaments",
    description:
      "Influencers can create, host, and manage gaming tournaments, while earning rewards.",
  },
  {
    id: 4,
    icon: Icon4,
    ...
    description:
      "Our API and SDK make it easy for game developers to onboard their games to the Peer2Play platform.",
  },
  {
    id: 5,
    icon: Icon5,
  ...
  return (
    <Container>
      ...
      <Grid container spacing={4} justifyContent="center" mt={4}>
        {metadata.map((item) => (
          <GridItem key={item.id} item xs={12} sm={6} md={4}>
